...
import 'package:madrasatymobile/UI/pages/Assignment/AssignmentImageViewer.dart';
import 'package:madrasatymobile/UI/pages/shared/PDFOpener.dart';
...
class _AssignmentDetailBottomSheetState
  ...
  void initState() {
    super.initState();
    print(widget.assignment.title);
    print(widget.assignment.type);
    print(widget.assignment.details);
    print(widget.assignment.divisionId);
    print(widget.assignment.subject);
    print(widget.assignment.timeStamp);
  }
              ...
              children: <Widget>[
                ...
                TextField(
                  controller: TextEditingController(
                      text: widget.assignment.userId.toString()),
                  enabled: false,
                  decoration: kTextFieldDecoration.copyWith(
                ...
                TextField(
                  enabled: false,
                  controller: TextEditingController(
                    text: widget.assignment.timeStamp != null
                        ? DateFormat("MMM d, E")
                            .add_jm()
                            .format(DateTime.parse(widget.assignment.timeStamp))
                        : '',
                  ),
                  decoration: kTextFieldDecoration.copyWith(
                    hintText: 'Time',
