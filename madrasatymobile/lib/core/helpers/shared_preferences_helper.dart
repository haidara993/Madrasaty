...
class SharedPreferencesHelper {
  ...
  final String _schoolCode = 'schooCode';
  ...
  Future<bool> setUserDataModel(User jsonModel) async {
    final SharedPreferences preferences = await SharedPreferences.getInstance();
    String user = jsonEncode(User.fromJson(jsonModel.toJson()));
    bool res = await preferences.setString(_userModel, user);
    // print('User data model saved ' + res.toString() + ' ' + user);
    return res;
  }
  ...
  Future<bool> setLoggedInUserId(int id) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    bool res = await prefs.setInt(_loggedInUserId, id);
    // print('User Id Saved' + res.toString());
    return res;
  }
  ...
  Future<int> getLoggedInUserId() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    int res = prefs.getInt(_loggedInUserId);
  ...
  Future<UserType> getUserType() async {
    ...
    String userType =
        prefs.getString(_userType) ?? UserTypeHelper.getValue(UserType.Unkown);
  ...
  Future<String> getCountryName() async {
    ...
    return countryNamePrefs.getString(_kCountryNamePrefs) ?? 'Syria';
  }
